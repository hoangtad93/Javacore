...
public class Demo_Staff {
	public static void main(String[] args) {
		...
		// System.out.println("thong tin mentor: " + " ID: " + mentor1.getId() + " |
		// Name: " + mentor1.getName()
		// + " | Gender: " + mentor1.getGender() + " | YearsOfExperience: " +
		// mentor1.getYearsOfExperience());
		System.out.println("----------------------------------------------------------- ");
		// tao Student
		...
		// System.out.println("thong tin Student: " + " ID: " + student1.getId() + " |
