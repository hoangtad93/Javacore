...
// ktra ket noi thanh cong hay chua
	...
	public void question2() throws ClassNotFoundException, SQLException {
		...
		ResultSet posResult = jdbc.executeQuery(sql);// executeQuery đưa ra câu lênh để chạy- select
...
// tạo position mới trên hệ thống
...
//		String positionInput = ScannerUltis.inputString();
//		preStatement.setString(1, positionInput);
