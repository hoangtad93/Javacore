...
public class AccountFunction {
	...
	public static void showAccount() throws ClassNotFoundException, SQLException, FileNotFoundException, IOException {
		AccountController accountController = new AccountController();

		List<Account> listAccounts = accountController.getListAccounts();
	...
	public static void showAccountById() throws Exception {
	...
	private static int getPos() throws ClassNotFoundException, SQLException, FileNotFoundException, IOException {
		while (true) {
			...
			if (possitionControler.getPositionByID(choosePos) != null) {
				return choosePos;
			} else {
	...
	private static int getNewIDPos() throws ClassNotFoundException, SQLException, FileNotFoundException, IOException {
		...
		while (true) {
			...
			if (possitionControler.getPositionByID(id) != null) {
				return id;
			} else {
